...
This github repo replicates the materials in openICPSR repo accessible [here](https://www.openicpsr.org/openicpsr/project/158002/version/V1/view).

Repository of code associated with the paper "Using Neural Networks to Predict Micro-Spatial Economic Growth", which is published at the journal American Economic Review: Insights.
...
In this phase, we extract the raw imagery and census data used to train our models. Cleaned and processed data ready for training (e.g. the output of this phase) is avilable [here](https://drive.google.com/drive/folders/1VKKD3JutzI9WdmHpZ2ZRKhwXD8Kw0YSc?usp=share_link).
...
Trained models are available in the weights folder [here](https://drive.google.com/drive/folders/1k0gNFb2CUfqjsYNUwpJVBl1Y5SfkJPyC?usp=share_link). These trained weights may be used for transfer learning (e.g. using our weights to generate features from different imagery). Models are named according to the following conventions:
...
### Instructions
1. Download data in data folder [here](https://drive.google.com/drive/folders/1VKKD3JutzI9WdmHpZ2ZRKhwXD8Kw0YSc?usp=share_link). 
...
1. Download trained models in weights folder here [here](https://drive.google.com/drive/folders/1k0gNFb2CUfqjsYNUwpJVBl1Y5SfkJPyC?usp=share_link), or run the training scripts as described in the previous phase. Each model is represented by a directory in the folder linked here. Copy the models to the `/weights` folder of this repository.
2. Download the prediction data (if you haven't already) which is the `testing_dataset` in the data folder [here](https://drive.google.com/drive/folders/1VKKD3JutzI9WdmHpZ2ZRKhwXD8Kw0YSc?usp=share_link) and unzip it to the `/data` folder of this repository.
...
**Folder `data` [link](https://drive.google.com/drive/folders/1VKKD3JutzI9WdmHpZ2ZRKhwXD8Kw0YSc?usp=share_link); (368gb; 9 files)**:
...
**Folder `weights` [link](https://drive.google.com/drive/folders/1k0gNFb2CUfqjsYNUwpJVBl1Y5SfkJPyC?usp=share_link); (141gb; 18,511 files)**:
