...
python "code\generate image labels\python\intersect_images_small.py"
"""
...
def f(state):
        ...
        try:                        
                ...
                for i in range(0,77):
                        arcpy.TabulateIntersection_analysis("squares_byimg_national_small{}".format(i), "img_id", "shapes10{}".format(state), r"data\labels\generated files\image_intersections\int10_{}_national_small{}.csv".format(state, i), "GISJOIN")
