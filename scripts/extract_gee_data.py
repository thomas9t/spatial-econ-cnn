...
#Follow the google earth engine instructions to first create an appropriate python environment for extraction (ee)
conda activate ee
#enter the filepath of this file on your system below
python "C:\Users\...   satellite_CNN_GEE_export_AERI.py"
"""

# The patch dimension controls the size of the extracted images
# 80x80 is our "large" image size, 40x40 is our "small" image size
PATCH_DIMENSION = [80,80]
...
def outfeat(fnum):
  ...
  tfr_opts = {}
  tfr_opts['patchDimensions'] = PATCH_DIMENSION
  tfr_opts['kernelSize'] = [15,15]

  
  task=ee.batch.Export.image.toDrive(
    folder='TFR_sr_p80k15_prediction_blobs_papi_national_coder_getall',  # The name of the directory in GD to which data will be written
